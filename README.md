...
*START at the top, TARGET behind a rule at the bottom, and the chain filling the gap between them; on each rung the letter that changed from the rung above is set in the accent colour.*
